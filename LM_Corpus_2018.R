...
state_data = subset(state_data, SEX1 == 1 | SEX1 == 2)
...
state_data$GENDER_00[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][1]
state_data$GENDER_02[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][2]
state_data$GENDER_04[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][3] 
state_data$GENDER_05[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][4]
state_data$GENDER_08[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][5] 
state_data$GENDER_11[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][6]
state_data$GENDER_14[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][7]
state_data$GENDER_16[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][8] 
state_data$GENDER_17[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][9]
state_data$GENDER_20[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][10]
state_data$GENDER_21[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][11] 
state_data$GENDER_22[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][12]
state_data$GENDER_24[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][13]
state_data$GENDER_26[state_data$SEX1 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][14] 
...
state_data$GENDER_00[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][1]
state_data$GENDER_01[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][2]
state_data$GENDER_02[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][3]
state_data$GENDER_04[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][4]
state_data$GENDER_05[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][5]
state_data$GENDER_13[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][6]
state_data$GENDER_14[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][7]
state_data$GENDER_15[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][8]
state_data$GENDER_16[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][9]
state_data$GENDER_17[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][10]
state_data$GENDER_18[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][11]
state_data$GENDER_20[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][12]
state_data$GENDER_21[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][13]
state_data$GENDER_22[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][14]
state_data$GENDER_24[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][15]
state_data$GENDER_26[state_data$SEX1 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][16]
...
write.csv(state_data, "LLCP2018XPT_LINEAR_WHOICD_V2C.csv")
