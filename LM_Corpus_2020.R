...
LM_Q258 <- LM_words %>% filter(word %in% Q258)  
LM_Q259 <- LM_words %>% filter(word %in% Q259)  
LM_Q260 <- LM_words %>% filter(word %in% Q260)  
LM_Q261 <- LM_words %>% filter(word %in% Q261)  
LM_Q262 <- LM_words %>% filter(word %in% Q262)  
LM_Q263 <- LM_words %>% filter(word %in% Q263)  
LM_Q264 <- LM_words %>% filter(word %in% Q264)  
LM_Q265 <- LM_words %>% filter(word %in% Q265)  
LM_Q266 <- LM_words %>% filter(word %in% Q266)  
LM_Q267 <- LM_words %>% filter(word %in% Q267)  
LM_Q268 <- LM_words %>% filter(word %in% Q268)  
LM_Q269 <- LM_words %>% filter(word %in% Q269)  
LM_Q270 <- LM_words %>% filter(word %in% Q270)  
LM_Q271 <- LM_words %>% filter(word %in% Q271)  
LM_Q272 <- LM_words %>% filter(word %in% Q272)  
LM_Q273 <- LM_words %>% filter(word %in% Q273)  
LM_Q274 <- LM_words %>% filter(word %in% Q274)  
LM_Q275 <- LM_words %>% filter(word %in% Q275)  
LM_Q276 <- LM_words %>% filter(word %in% Q276)  
LM_Q277 <- LM_words %>% filter(word %in% Q277)  
LM_Q278 <- LM_words %>% filter(word %in% Q278)  
LM_Q279 <- LM_words %>% filter(word %in% Q279)  
...
write.csv(state_data, "LLCP2020XPT_LINEAR_WHOICD_V2C.csv")
