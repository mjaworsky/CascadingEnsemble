...
write.csv(smoke_5y, "LLCP_ALCOHOL_5YEAR.csv")
...
write.csv(smoke_5y, "LLCP_DIABETES_5YEAR.csv")
...
write.csv(smoke_5y, "LLCP_GENDER_WEIGHT_5YEAR.csv")
...
write.csv(smoke_5y, "LLCP_GENDER_INJURY_FATIGUE_5YEAR.csv")
