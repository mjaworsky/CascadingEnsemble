...
write.csv(state_data, "LLCP2021XPT_LINEAR_WHOICD_V2C.csv")

setwd('C:\\Users\\mdjaw\\OneDrive\\Documents\\Markian Training\\Research_USQ\\USCenterDiseaseControlPrevention\\LLCP2021XPT')
state_data2021 <- read.csv('LLCP2021XPT_LINEAR_WHOICD_V2C.csv')
state_data2021 <- state_data2021[, !(names(state_data2021) %in% "X")]

setwd('C:\\Users\\mdjaw\\OneDrive\\Documents\\Markian Training\\Research_USQ\\USCenterDiseaseControlPrevention\\LLCP2020XPT')
state_data2020 <- read.csv('LLCP2020XPT_LINEAR_WHOICD_V2C.csv')
state_data2020 <- state_data2020[, !(names(state_data2020) %in% "X")]

setwd('C:\\Users\\mdjaw\\OneDrive\\Documents\\Markian Training\\Research_USQ\\USCenterDiseaseControlPrevention\\LLCP2019XPT')
state_data2019 <- read.csv('LLCP2019XPT_LINEAR_WHOICD_V2C.csv')
state_data2019 <- state_data2019[, !(names(state_data2019) %in% "X")]

setwd('C:\\Users\\mdjaw\\OneDrive\\Documents\\Markian Training\\Research_USQ\\USCenterDiseaseControlPrevention\\LLCP2018XPT')
state_data2018 <- read.csv('LLCP2018XPT_LINEAR_WHOICD_V2C.csv')
state_data2018 <- state_data2018[, !(names(state_data2018) %in% "X")]
names(state_data2018)[names(state_data2018) == "DIABETE3"] <- "DIABETE4"

setwd('C:\\Users\\mdjaw\\OneDrive\\Documents\\Markian Training\\Research_USQ\\USCenterDiseaseControlPrevention\\LLCP2017XPT')
state_data2017 <- read.csv('LLCP2017XPT_LINEAR_WHOICD_V2C.csv')
state_data2017 <- state_data2017[, !(names(state_data2017) %in% "X")]
names(state_data2017)[names(state_data2017) == "DIABETE3"] <- "DIABETE4"

data2021_2020 <- rbind(state_data2021, state_data2020)
data2019_2020_2021 <- rbind(data2021_2020, state_data2019)
data2018_2019_2020_2021 <- rbind(data2019_2020_2021, state_data2018)
data2017_2018_2019_2020_2021 <- rbind(data2018_2019_2020_2021, state_data2017)

data2017_2018_2019_2020_2021[is.na(data2017_2018_2019_2020_2021)] <- 0

write.csv(data2017_2018_2019_2020_2021, "LLCP2017_2018_2019_2020_2021XPT_LINEAR_WHOICD_5YEAR.csv")

smoke_5y = subset(data2017_2018_2019_2020_2021, select = c(CNCRTYP1,CNCRAGE,DIABETE4,SMOKE_01,SMOKE_02,SMOKE_03,SMOKE_04,SMOKE_05,SMOKE_06,SMOKE_07,SMOKE_08,SMOKE_09,SMOKE_10,SMOKE_11,SMOKE_12,SMOKE_13,SMOKE_14,SMOKE_15,SMOKE_16,SMOKE_17,SMOKE_18,SMOKE_19,SMOKE_20,SMOKE_21,SMOKE_22,SMOKE_23,SMOKE_24,SMOKE_25,SMOKE_26))

write.csv(smoke_5y, "LLCP_SMOKE_5YEAR.csv")


alcohol_5y = subset(data2017_2018_2019_2020_2021, select = c(CNCRTYP1,CNCRAGE,DIABETE4,DRINK_01,DRINK_02,DRINK_03,DRINK_04,DRINK_05,DRINK_06,DRINK_07,DRINK_08,DRINK_09,DRINK_10,DRINK_11,DRINK_12,DRINK_13,DRINK_14,DRINK_15,DRINK_16,DRINK_17,DRINK_18,DRINK_19,DRINK_20,DRINK_21,DRINK_22,DRINK_23,DRINK_24,DRINK_25,DRINK_26))

write.csv(alcohol_5y, "LLCP_ALCOHOL_5YEAR.csv")


diabetes_5y = subset(data2017_2018_2019_2020_2021, select = c(CNCRTYP1,CNCRAGE,DIABETE4,LABEL_00,LABEL_01,LABEL_02,LABEL_03,LABEL_04,LABEL_05,LABEL_06,LABEL_07,LABEL_08,LABEL_09,LABEL_10,LABEL_11,LABEL_12,LABEL_13,LABEL_14,LABEL_15,LABEL_16,LABEL_17,LABEL_18,LABEL_19,LABEL_20,LABEL_21,LABEL_22,LABEL_23,LABEL_24,LABEL_25,LABEL_26,PDTEST_01,PDTEST_02,PDTEST_03,PDTEST_04,PDTEST_05,PDTEST_06,PDTEST_07,PDTEST_08,PDTEST_09,PDTEST_10,PDTEST_11,PDTEST_12,PDTEST_13,PDTEST_14,PDTEST_15,PDTEST_16,PDTEST_17,PDTEST_18,PDTEST_19,PDTEST_20,PDTEST_21,PDTEST_22,PDTEST_23,PDTEST_24,PDTEST_25,PDTEST_26))

write.csv(diabetes_5y, "LLCP_DIABETES_5YEAR.csv")

gender_weight_5y = subset(state_data, select = c(CNCRTYP1,CNCRAGE,GENDER_00,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,WEIGHT_00,WEIGHT_01,WEIGHT_02,WEIGHT_03,WEIGHT_04,WEIGHT_05,WEIGHT_06,WEIGHT_07,WEIGHT_08,WEIGHT_09,WEIGHT_10,WEIGHT_11,WEIGHT_12,WEIGHT_13,WEIGHT_14,WEIGHT_15,WEIGHT_16,WEIGHT_17,WEIGHT_18,WEIGHT_19,WEIGHT_20,WEIGHT_21,WEIGHT_22,WEIGHT_23,WEIGHT_24,WEIGHT_25,WEIGHT_26))

write.csv(gender_weight_5y, "LLCP_GENDER_WEIGHT_5YEAR.csv")

gender_injury_fatigue_5y = subset(state_data, select = c(CNCRTYP1,CNCRAGE,GENDER_00,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))

write.csv(gender_injury_fatigue_5y, "LLCP_GENDER_INJURY_FATIGUE_5YEAR.csv")
