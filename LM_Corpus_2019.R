...
Q184 <- tolower(c('During','the','past','12','months','have','you','experienced','confusion','or','memory','loss','that','is','happening','more','often','or','is','getting','worse'))
Q185 <- tolower(c('During','the','past','12','months','as','a','result','of','confusion','or','memory','loss','how','often','have','you','given','up','day','to','day','household','activities','or','chores','you','used','to','do','such','as','cooking','cleaning','taking','medications','driving','or','paying','bills','Would','you','say','it','is','Always','Usually','Sometimes','Rarely','Never'))
Q186 <- tolower(c('As','a','result','of','confusion','or','memory','loss','how','often','do','you','need','assistance','with','these','day','to','day','activities','Would','you','say','it','is','Always','Usually','Sometimes'))
Q187 <- tolower(c('When','you','need','help','with','these','day','to','day','activities','how','often','are','you','able','to','get','the','help','that','you','need','Would','you','say','it','is','Always','Usually','Sometimes','Rarely','Never'))
...
Q194 <- tolower(c('What','is','the','main','health','problem','long','term','illness','or','disability','that','the','person','you','care','for','has'))
Q195 <- tolower(c('Does','the','person','you','care','for','also','have','Alzheimers','disease','dementia','or','other','cognitive','impairment','disorder'))
...
Q228 <- tolower(c('What','is','the','birth','month','and','year','of','the','Xth','child'))
Q229 <- tolower(c('Is','the','child','a','boy','or','a','girl'))
Q230 <- tolower(c('Is','the','child','Hispanic','Latino','Latina','or','Spanish','origin'))
Q231 <- tolower(c('Which','one','or','more','of','the','following','would','you','say','is','the','race','of','the','child','White','Black','or','African','American','American','Indian','or','Alaska','Native','Asian','Asian','Indian','Chinese','Filipino','Japanese','Korean','Vietnamese','Other','Asian','Pacific','Islander','Native','Hawaiian','Guamanian','or','Chamorro','Samoan','Other','Pacific','Islander'))
Q232 <- tolower(c('Which','one','of','these','groups','would','you','say','best','represents','the','child','race','White','Black','or','African','American','American','Indian','or','Alaska','Native','Asian','Asian','Indian','Chinese','Filipino','Japanese','Korean','Vietnamese','Other','Asian','Pacific','Islander','Native','Hawaiian','Guamanian','or','Chamorro','Samoan','Other','Pacific','Islander'))
Q233 <- tolower(c('How','are','you','related','to','the','child','Are','you','a','Parent','include','biologic','step','or','adoptive','parent','Grandparent','Foster','parent','or','guardian','Sibling','include','biologic','step','and','adoptive','sibling','Other','relative','Not','related','in','any','way'))
Q234 <- tolower(c('Has','a','doctor','nurse','or','other','health','professional','EVER','said','that','the','child','has','asthma'))
Q235 <- tolower(c('Does','the','child','still','have','asthma'))
Q236 <- tolower(c('Would','it','be','okay','if','we','called','you','back','to','ask','additional','asthma','related','questions','at','a','later','time'))
Q237 <- tolower(c('Which','person','in','the','household','was','selected','as','the','focus','of','the','asthma','call','back'))
...
write.csv(state_data, "LLCP2019XPT_LINEAR_WHOICD_V2C.csv")
